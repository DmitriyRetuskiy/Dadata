...
return [
    ...
    */
    'custom_types' => [
        'uuid' => App\Shared\Infrastructure\Persistence\Doctrine\Type\UuidType::class,
        'status_enum' => App\Shared\Infrastructure\Persistence\Doctrine\Type\StatusEnumType::class
    ],
    /*
    |--------------------------------------------------------------------------
